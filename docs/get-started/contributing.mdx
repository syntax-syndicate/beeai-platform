...
This document is useful for **contributors** to the BeeAI platform. If you want to use the platform, follow the [installation instructions](/introduction/installation) instead.
