...
- **[Homebrew](https://brew.sh/)** (recommended): A cross-platform package manager for Linux and Mac. This method will install all dependencies for you, as well as manage background services.
...
- **PyPI**: Python-native way of installing. This method is less preferred since it requires more manual steps to complete.
    ...
    6. (optional) Open a new terminal window and run `phoenix serve` to run the Arize Phoenix UI. Also keep this terminal window open and running.
