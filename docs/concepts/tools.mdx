...
Tools can be accessed programmatically by agents through the ACP SDK package or directly via [MCP](https://modelcontextprotocol.io/). This enables integration with frameworks through adapters such as:
