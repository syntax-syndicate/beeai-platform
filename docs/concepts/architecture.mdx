...
An agent is a container that communicates using the [Agent Communication Protocol](/acp). Agents typically define a manifest that instructs BeeAI on how to run them and may include additional features like tools.
