...
<Info>
    Dive into the [beeai-server source code](https://github.com/i-am-bee/beeai/tree/main/apps/beeai-server).
</Info>
...
<Info>
    ...
    [beeai-ui](https://github.com/i-am-bee/beeai/tree/main/apps/beeai-ui) repositories.
</Info>
