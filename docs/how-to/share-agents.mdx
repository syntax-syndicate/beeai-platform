...
beeai add "https://github.com/your-username/monorepo@main#path=/agents/my-agent"
```

<Tip> 
**Versioning Tip**: Use Git tags like `v1.0.0`, `v1.1.0`, etc., to manage releases. BeeAI automatically builds and caches tagged versions to speed up installs. 
</Tip>
