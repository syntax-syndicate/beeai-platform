...
def global_provider_variables(configuration: Configuration):
    return {
        ...
        "PLATFORM_URL": f"http://{configuration.platform_service_name}:{configuration.port}",
        "LLM_MODEL": "dummy",
        "LLM_API_KEY": "dummy",
        "LLM_API_BASE": f"http://{configuration.platform_service_name}:{configuration.port}/api/v1/llm",
    }
